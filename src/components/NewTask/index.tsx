...
function AddTaskList() {
    return(
        <div className=" flex justify-center  left-[calc(50%-736px/2)] top-[180px]  w-[734px] absolute">
            <input type="text" className=" bg-grayToDoList500 w-[534px]  placeholder:text-grayToDoList100  px-4  py-2   border border-blackToDoList relative  text-grayToDoList100 rounded-lg  " placeholder="Adicione uma nova tarefa" />
